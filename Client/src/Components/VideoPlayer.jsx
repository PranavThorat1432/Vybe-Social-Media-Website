...
const VideoPlayer = ({media}) => {
  ...
  return (
    <div className='h-full relative cursor-pointer max-w-full rounded-2xl overflow-hidden'>
        <video ref={videoTag} src={media} autoPlay loop muted={mute} className='h-full relative cursor-pointer max-w-full rounded-2xl' onClick={handleClick}/>

        <div className='absolute bottom-2.5 right-2.5 text-white' onClick={() => setMute(!mute)}>
